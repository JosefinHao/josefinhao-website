...
(function() {
    ...
    function initializePageScripts(path) {
        ...
        if (path === '/') {
            // Wait for DOM to be ready, then reinit carousel
        ...
        if (path === '/games') {
            // Games scripts should auto-initialize when DOM is ready
            // Dispatch a custom event that game scripts can listen for
